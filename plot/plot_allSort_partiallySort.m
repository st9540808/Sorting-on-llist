is = fopen('.plot_allSort_partiallySort_data_is', 'r');
x1 = fscanf(is, '%d,%f', [2, Inf]);
rms = fopen('.plot_allSort_partiallySort_data_rms', 'r');
x2 = fscanf(rms, '%d,%f', [2, Inf]);
ims = fopen('.plot_allSort_partiallySort_data_ims', 'r');
x3 = fscanf(ims, '%d,%f', [2, Inf]);
nms = fopen('.plot_allSort_partiallySort_data_nms', 'r');
x4 = fscanf(nms, '%d,%f', [2, Inf]);
qs = fopen('.plot_allSort_partiallySort_data_qs', 'r');
